...
/*   Updated: 2024/09/04 20:08:37 by bonsthie         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
# define RTSS_TYPE_ATTR                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                       \
	{                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                        \
		"width", "height", "min-width", "max-width", "min-height", "max-height", \
			"padding", "padding-left", "padding-right", "padding-bottom", \
			"padding-top", "margin", "margin-left", "margin-right", \
			"margin-bottom", "margin-top", "border", "border-width", \
			"border-style", "border-color", "border-top", "border-top-width", \
