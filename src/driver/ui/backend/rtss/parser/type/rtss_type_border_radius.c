...
/*   Updated: 2024/09/10 15:59:01 by bonsthie         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
{
	hentry_add_spec(tab, entry, (t_keyw)BORDER_RADIUS,
		__rtss_bit_packing(&value));
}
		...
		char *value)
{
	...
	hentry_add_spec(tab, entry, (t_keyw)BORDER_RADIUS,
		__rtss_bit_packing_1(&value, base));
}
		...
		char *value)
{
	...
	base = hentry_get_spec(tab, entry, (t_keyw)BORDER_RADIUS);
	hentry_add_spec(tab, entry, (t_keyw)BORDER_RADIUS,
		__rtss_bit_packing_2(&value, base));
}
		...
		char *value)
{
	...
	base = hentry_get_spec(tab, entry, (t_keyw)BORDER_RADIUS);
	hentry_add_spec(tab, entry, (t_keyw)BORDER_RADIUS,
		__rtss_bit_packing_3(&value, base));
}
		...
		char *value)
{
	...
	base = hentry_get_spec(tab, entry, (t_keyw)BORDER_RADIUS);
	hentry_add_spec(tab, entry, (t_keyw)BORDER_RADIUS,
		__rtss_bit_packing_4(&value, base));
}
