...
/*   Updated: 2024/09/09 21:12:13 by bonsthie         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void rtss_type_margin_left(t_htab *tab, t_hentry *entry, char *value)
{
	...
	hentry_add_spec(tab, entry, (t_keyw)MARGIN, __rtss_bit_packing_1(&value, base));
}
...
void rtss_type_margin_bottom(t_htab *tab, t_hentry *entry, char *value)
{
	...
	base = hentry_get_spec(tab, entry, (t_keyw)MARGIN);
	hentry_add_spec(tab, entry, (t_keyw)MARGIN, __rtss_bit_packing_2(&value, base));
}
void rtss_type_margin_right(t_htab *tab, t_hentry *entry, char *value)
{
	...
	base = hentry_get_spec(tab, entry, (t_keyw)MARGIN);
	hentry_add_spec(tab, entry, (t_keyw)MARGIN, __rtss_bit_packing_3(&value, base));
}
...
void rtss_type_margin_top(t_htab *tab, t_hentry *entry, char *value)
{
	...
	base = hentry_get_spec(tab, entry, (t_keyw)MARGIN);
	hentry_add_spec(tab, entry, (t_keyw)MARGIN, __rtss_bit_packing_4(&value, base));
}
